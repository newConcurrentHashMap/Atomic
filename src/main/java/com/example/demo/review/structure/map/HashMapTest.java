...
import com.example.demo.review.structure.map.test.HashMapPrinter;
...
public class HashMapTest<K,V> extends AbstractMapTest<K,V>
    ...
    public static class Node<K,V> implements MapTest.Entry<K,V> {
        ...
        public final boolean equals(Object o) {
            if (o == this)
                return true;
            if (o instanceof MapTest.Entry) {
                MapTest.Entry<?,?> e = (MapTest.Entry<?,?>)o;
     ...
     */
    transient SetTest<Entry<K,V>> entrySet;
     ...
     */
    public HashMapTest(MapTest<? extends K, ? extends V> m) {
     ...
     */
    final void putMapEntries(MapTest<? extends K, ? extends V> m, boolean evict) {
        int s = m.size();
        if (s > 0) {
            if (table == null) { // pre-size
                ...
                resize();
            for (MapTest.Entry<? extends K, ? extends V> e : m.entrySet()) {
                K key = e.getKey();
                V value = e.getValue();
    ...
    final class KeySet extends AbstractSetTest<K> {
...
//        }
    ...
    final class Values extends AbstractCollectionTest<V> {
        public final int size()                 { return size; }
        public final void clear()               { this.clear(); }
...
//        }
     ...
     */
    public SetTest<MapTest.Entry<K,V>> entrySet() {
        SetTest<MapTest.Entry<K,V>> es;
        return (es = entrySet) == null ? (entrySet = new EntrySet()) : es;
    }

    final class EntrySet extends AbstractSetTest<MapTest.Entry<K,V>> {
        public final int size()                 { return size; }
        public final void clear()               { this.clear(); }
        public final Iterator<MapTest.Entry<K,V>> iterator() {
...
//        public final Spliterator<MapTest.Entry<K,V>> spliterator() {
//            return new EntrySpliterator<>(this, 0, -1, 0, 0);
//        }
        public final void forEach(ConsumerTest<? super MapTest.Entry<K,V>> action) {
            Node<K,V>[] tab;
            if (action == null)
                throw new NullPointerException();
            if (size > 0 && (tab = table) != null) {
    ...
    final class EntryIterator extends HashIterator
            implements Iterator<MapTest.Entry<K,V>> {
        public final MapTest.Entry<K,V> next() { return nextNode(); }
    }
...
//        }
//
//        public void forEachRemaining(ConsumerTest<? super MapTest.Entry<K,V>> action) {
//            int i, hi, mc;
//            if (action == null)
//                throw new NullPointerException();
//            HashMapTest<K,V> m = map;
...
//        }
//
//        public boolean tryAdvance(ConsumerTest<? super MapTest.Entry<K,V>> action) {
//            int hi;
//            if (action == null)
//                throw new NullPointerException();
//            Node<K,V>[] tab = map.table;
